...
const CardDeal = () => (
  <section className="flex flex-col md:flex-row items-center md:items-start mr-18 p-6 shadow-lg rounded-lg overflow-hidden">
    <div className={layout.sectionInfo}>
      ...
      <p
        className={`text-white max-w-[470px] mt-5 text-lg leading-relaxed`}
      >
