...
const Contact = () => {
  ...
  return (
    <section className="text-white min-h-screen mt-20" id="contact">
      ...
      <div className="container mx-auto flex flex-col md:flex-row items-center justify-between px-2 gap-6">
        <div className="md:w-1/2 text-center md:text-right">
          <form onSubmit={handleSubmit} className="w-full flex flex-col gap-4">
            ...
            <button
              type="submit"
              className="inline-flex items-center justify-center w-full md:w-auto h-12 px-6 bg-blue-500 hover:bg-blue-600 text-white font-bold rounded-md transition duration-300 ease-in-out focus:outline-none focus:ring-2 focus:ring-blue-500"
            >
